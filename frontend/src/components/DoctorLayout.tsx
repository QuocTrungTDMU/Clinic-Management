  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
            <div className="flex h-16 items-center justify-between px-4 bg-green-600">
            ...
            <div className="border-t border-gray-200 p-4">
              <div className="flex items-center mb-3">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-gray-500 capitalize">Bác sĩ</p>
                </div>
              </div>
              <button
      ...
      <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white shadow-lg">
        <div className="flex h-16 items-center px-6 bg-green-600">
          <HeartIcon className="h-8 w-8 text-white" />
          <span className="ml-2 text-xl font-bold text-white">Bác Sĩ</span>
        </div>
      ...
      <div className="lg:ml-64 flex-1">
        ...
        <div className="lg:hidden flex h-16 items-center justify-between px-4 bg-white shadow-sm">
          ...
          <div className="flex items-center">
            ...
            <span className="ml-2 text-lg font-bold text-gray-900">Bác Sĩ</span>
          </div>
          <div></div>
        </div>
